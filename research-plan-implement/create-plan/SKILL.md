---
name: create-plan
description: Create a detailed implementation plan based on codebase research. Use when a research document exists and the next step is to plan the implementation. Reads research findings and produces a phased, verifiable implementation plan.
---

# Create Implementation Plan

Creates a detailed implementation plan based on codebase research.
...
1. The path to your research document (e.g., tasks/YYYY-MM-DD-description/research.md)
...
4. **Generate implementation plan** as `plan.md` in the same directory as the provided research document
...
```
I've created a detailed implementation plan at <same directory as research>/plan.md.
...
Create `plan.md` in the same directory as the provided research document:
...
## References
- Research: `<path provided by user>`
