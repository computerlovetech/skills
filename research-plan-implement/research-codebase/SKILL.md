...
description: Research and document a codebase area thoroughly. Use when asked to investigate, map, understand, or document existing code before making changes. Produces a structured research document with file paths and line numbers.
---
...
6. **Create task directory**: `mkdir -p tasks/YYYY-MM-DD-description` — replace `YYYY-MM-DD` with today's date and `description` with a short kebab-case summary of the task (e.g., `tasks/2026-03-24-add-auth-middleware`)
7. **Generate research document** at `tasks/<task-dir>/research.md`
...
```
I've completed the research and documented my findings in tasks/<task-dir>/research.md.
