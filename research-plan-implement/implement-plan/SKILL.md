---
name: implement-plan
description: Execute an approved implementation plan phase by phase. Use when a plan document exists at tasks/YYYY-MM-DD-description/plan.md and the next step is to implement it. Tracks progress with checkmarks and stops for review between phases.
---

# Implement Plan

Implements an approved technical plan with phases, specific changes, and success criteria.
...
```
I'm ready to implement the plan. Please provide the path to your implementation plan (e.g., tasks/YYYY-MM-DD-description/plan.md).
...
No new file is created. The command updates the existing plan file by checking off items with `[x]` as they are completed:
